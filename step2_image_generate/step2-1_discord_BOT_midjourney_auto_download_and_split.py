    ...
    if response.status_code == 200:
        ...
        if "UPSCALED_" not in filename:
            ...
            if save_format == 'jpg':
                ...
                top_left.save(os.path.join(output_folder, file_prefix + "_top_left.png"), 'png')
                top_right.save(os.path.join(output_folder, file_prefix + "_top_right.png"), 'png')
                bottom_left.save(os.path.join(output_folder, file_prefix + "_bottom_left.png"), 'png')
                bottom_right.save(os.path.join(output_folder, file_prefix + "_bottom_right.png"), 'png')
        else:
